...
const ExperienceBar = ({
  ...
  const [levelStart, setLevelStart] = useState(
    Math.floor(experience_level_start)
  );
  ...
  return (
    <div className="experience-bar-container">
      <div className="level-area level-left">
        <div className="level-circle">{levelStart}</div>
      </div>
      <div className="experience-bar">
        <motion.div
          ...
          style={{
            width: `${
              (experience_level_start - Math.floor(experience_level_start)) *
              100
            }%`,
          }}
      ...
      <div className="level-area level-right">
        <div className="level-circle">{levelStart + 1}</div>
      </div>
    </div>
  );
};
