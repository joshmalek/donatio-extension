...
export default class AmazonOrderTotalInhibitor extends React.Component {
  ...
  showSubtotal() {
    ...
    if (subtotal == null || !window.donatio_global.donationActive())
      return this.props.defaultSubtotal;
    ...
    return (
      <React.Fragment>
        {window.donatio_global.donationActive() && (
          <div>
            <div className="left-mimic-cell">Charity donation:</div>
            <div className="right-mimic-cell">{this.showCharityTotal()}</div>
          </div>
        )}
        <div>
          <div
            className={`a-color-price a-size-medium a-text-bold left-mimic-cell ${
              window.donatio_global.donationActive()
                ? "active-donation-text"
                : ""
            }`}
          >
            Order total:
          ...
          <div
            className={`right-mimic-cell a-color-price a-size-medium a-text-right grand-total-price aok-nowrap a-text-bold a-nowrap right-cell  ${
              window.donatio_global.donationActive()
                ? "active-donation-text"
                : ""
            }`}
